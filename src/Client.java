...
public class Client {
    ...
    public void start() {
        ...
        try (Socket socket = new Socket("localhost", SERVER_PORT_NUMBER);
            ...
            while (true) {
                ...
                System.out.println("7. View All Products Json       <view json>");
                System.out.println("8. Find Product by ID           <find json id>");
                ...
                if (userRequest.equals("0") || userRequest.equalsIgnoreCase("exit")) {
                ...
                else if (userRequest.equals("8") || userRequest.toLowerCase().startsWith("find json")) {
                    System.out.print("Enter product ID: ");
                    String id = scanner.nextLine().trim();
                    socketWriter.println("find json " + id);
                    String response = socketReader.readLine();
                    ...
                    dao.handleDisplayProductById(userRequest, socketWriter, socketReader);

                    // Option 7: Display All Entities
                } else if (userRequest.equals("7") || userRequest.equalsIgnoreCase("entities")) {
                    dao.displayAllEntities(socketWriter, socketReader);

                    // All other commands (view, find, insert, update, delete, search)
                } else if (dao.isRecognizedCommand(userRequest)) {
    ...
    public void handleDisplayProductById(String userRequest, PrintWriter socketWriter, BufferedReader socketReader) throws IOException {
